...
class TrendingInfo extends LitElement {
  ...
  render() {
    ...
    <section>
      ...
      <type-style class="size-14px regular" username=${this.timestamp}>${this.timestamp}</type-style>
      </div>
      ...
      <type-style class="size-14px bold" username=${this.hashtag}>${this.hashtag}</type-style>
      </div>
    </section>
